            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                        	...
                        	<?php elseif($row['payment_method'] == 'Bank Deposit OR Bkash Payment'): ?>
                        		<b>Payment Method:</b> <?php echo '<span style="color:red;"><b>'.$row['payment_method'].'</b></span>'; ?><br>
                        		<b>Payment Id:</b> <?php echo $row['payment_id']; ?><br>
								<b>Date:</b> <?php echo $row['payment_date']; ?><br>
                        ...
                        <td>
                            ...
                            <?php
                                if($row['payment_status']=='Pending'){
                                    ...
                                    <a href="order-change-status.php?id=<?php echo $row['id']; ?>&task=Cancel" class="btn btn-danger btn-xs" style="width:100%;margin-bottom:4px;">Cancel</a>
                                    <?php
                                }
                            ?>
                        </td>
                        <td>
                            ...
                            if($row['payment_status']=='Completed') {
                                if($row['shipping_status']=='Pending'){
                                    ...
                                    <a href="shipping-change-status.php?id=<?php echo $row['id']; ?>&task=Cancel" class="btn btn-danger btn-xs" style="width:100%;margin-bottom:4px;">Cancel</a>
                                    <?php
                                }
                            }
                            ?>
                        ...
                        <td>
                        <?php if($row['need_prescription']==4){echo 'Approved';}else{echo 'Not Approved';} ?>
                        </td>
	                    <td>
