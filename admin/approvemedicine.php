...
Card Year: '.$row['card_year'].'<br>
        		';
        	elseif($row['payment_method'] == 'Bank Deposit OR Bkash Payment'):
				$payment_details = '
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
	                    ...
	                    <td>
                        <?php if($row['need_prescription']==0){echo 'No need';}elseif($row['need_prescription']==1){echo 'need prescription';}elseif($row['need_prescription']==3){echo 'Prescription Given';}  elseif($row['need_prescription']==4){echo 'Approve';}elseif($row['need_prescription']==5){echo 'Medicine is Not Approve';}?>
                            <a class="btn btn-info btn-xs <?php if($row['need_prescription']==3 || $row['need_prescription']==4 || $row['need_prescription']==5){echo 'disabled';}?>" href="prescriptionneed.php?id=<?php echo $row['id']; ?>&task=1" data-toggle="" data-target="" style="width:100%;">Give Prescription</a><br><br> 
                            <a href="#" class="btn btn-primary btn-xs" data-href="order-delete.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete" style="width:100%;">See Prescription</a><br><br>
                            <a class="btn btn-success btn-xs" href="prescriptionneed.php?id=<?php echo $row['id']; ?>&task=4" data-toggle="" data-target="" style="width:100%;">Approve</a><br><br>
                            <a class="btn btn-danger btn-xs <?php if($row['need_prescription']==4){echo 'disabled';}?>" href="prescriptionneed.php?id=<?php echo $row['id']; ?>&task=5" data-toggle="" data-target="" style="width:100%;">Not Approve</a>
	                    </td>
	                </tr>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">See the Prescription</h4>
                                </div>
                                <div class="modal-body">
                                   <img src="../<?php echo $row['prescription_image'];?>" alt="" width="500px" height="900px">
