...
<head>
	...
	<?php if ($_SESSION['login_as_Pharmacists']) { ?>
...
<body class="hold-transition fixed skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<?php if (isset($_SESSION['login_as_Pharmacists'])) { ?>
			<a href="approvemedicine.php" class="logo">
				<span class="logo-lg">Easymeds</span>
			</a>
		<?php } else { ?>
		...
		<?php } ?>
			...
			<nav class="navbar navbar-static-top">
				...
				<?php }elseif(isset($_SESSION['login_as_Pharmacists'])){ ?>
				<span style="float:left;line-height:50px;color:#fff;padding-left:15px;font-size:18px;">Pharmacist Panel</span>
				<?php } ?>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
				  ...
				  <?php if(!isset($_SESSION['login_as_Pharmacists'])){ ?>
					...
					<li class="treeview <?php if( ($cur_page == 'pharmasist.php') || ($cur_page == 'pharmasist-add.php') || ($cur_page == 'pharmasist-edit.php') ) {echo 'active';} ?>">
			          <a href="pharmasist.php">
			            <i class="fa fa-hand-o-right"></i> <span>pharmasist</span>
			          </a>
			        </li>
					...
					<?php } elseif(isset($_SESSION['login_as_Pharmacists'])){ ?>
					<li class="treeview <?php if( ($cur_page == 'approvemedicine.php')||($cur_page == 'approvemedicine.php') ) {echo 'active';} ?>">
			          <a href="approvemedicine.php">
			            <i class="fa fa-hand-o-right"></i> <span>Approve Medicine</span>
			          </a>
			        </li>
					<?php } ?>
