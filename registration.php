...
if (isset($_POST['form1'])) {
    ...
    elseif(!is_numeric($_POST['cust_phone'])==TRUE) {
        $valid = 0;
        $error_message .= "Phone number digit allowed<br>";
    }
    ...
    elseif(!is_numeric($_POST['cust_zip'])) {
        $valid = 0;
        $error_message .= "Zip Code only number allowed<br>";
    }
