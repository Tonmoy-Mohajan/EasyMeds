        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="user-content">
                    ...
                    <p class="text-danger">If any product status is cancel, You will get your refund in 24hour.</p>
            ...
            ?>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($row['need_prescription']==0){echo 'please wait 24hour if we need prescription, we let you know';}elseif($row['need_prescription']==1){?>
                                            <form action="prescriptionfile.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label for="exampleFormControlFile1">Prescrition need</label>
                                                    <input type="hidden" name="id" value="<?php echo $row['id'];?>">
                                                    <input type="file" name="brand_image" class="form-control-file"
                                                        id="exampleFormControlFile1"><br>
                                                    <button type="submit" name="submit" class="btn btn-primary text-white">Give Prescription</button>
                                                </div>
                                            </form>
                                       <?php }elseif($row['need_prescription']==3){echo 'Prescription Given';} elseif($row['need_prescription']==4){echo 'Approved';} ?></td>
                                    </tr>
                                    <?php
                                }
                                ?>                               
